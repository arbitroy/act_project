...
>(({ className, ...props }, ref) => (
    <ToastPrimitives.Action
        ...
        className={cn(
            ...
            "group-[.destructive]:border-red-300 group-[.destructive]:hover:border-red-400 group-[.destructive]:hover:bg-red-400 group-[.destructive]:focus:ring-red-400",
            "group-[.success]:border-green-300 group-[.success]:hover:border-green-400 group-[.success]:hover:bg-green-400 group-[.success]:focus:ring-green-400",
            "group-[.warning]:border-amber-300 group-[.warning]:hover:border-amber-400 group-[.warning]:hover:bg-amber-400 group-[.warning]:focus:ring-amber-400",
            "group-[.info]:border-blue-300 group-[.info]:hover:border-blue-400 group-[.info]:hover:bg-blue-400 group-[.info]:focus:ring-blue-400",
            className
        )}
        {...props}
    />
